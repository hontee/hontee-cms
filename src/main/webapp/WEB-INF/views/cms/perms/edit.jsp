...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="perms-edit-form" action="/cms/perms/${record.id}/edit" method="post">
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="permsEditSubmitForm()" style="width:100%;height:32px">更新</button>
  </form>
  </div>
</div>
<script>
function permsEditSubmitForm(){
  $('#perms-edit-form').form({
    success: function(data) {
    	CMS.editSubmitHandler(data, permsEL);
    }
  });
}
</script>
