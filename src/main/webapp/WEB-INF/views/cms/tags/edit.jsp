...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="tags-edit-form" action="/cms/tags/${record.id}/edit" method="post">
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="tagsEditSubmitForm()" style="width:100%;height:32px">更新</button>
  </form>
  </div>
</div>
<script>
function tagsEditSubmitForm(){
  $('#tags-edit-form').form({
    success: function(data) {
    	CMS.editSubmitHandler(data, tagsEL);
    }
  });
}
</script>
