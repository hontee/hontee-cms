...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="tags-add-form" action="/cms/tags/new" method="post">
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="tagsAddSubmitForm()" style="width:100%;height:32px">创建</button>
  </form>
  </div>
</div>
<script>
function tagsAddSubmitForm(){
  $('#tags-add-form').form({
    success: function(data) {
    	CMS.addSubmitHandler(data, tagsEL);
    }
  });
}
</script>
