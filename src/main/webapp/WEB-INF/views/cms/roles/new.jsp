...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="roles-add-form" action="/cms/roles/new" method="post">
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="rolesAddSubmitForm()" style="width:100%;height:32px">创建</button>
  </form>
  </div>
</div>
<script>
function rolesAddSubmitForm(){
  $('#roles-add-form').form({
    success: function(data) {
    	CMS.addSubmitHandler(data, rolesEL);
    }
  });
}
</script>
