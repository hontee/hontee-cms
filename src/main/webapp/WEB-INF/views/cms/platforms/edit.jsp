...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="platforms-edit-form" action="/cms/platforms/${record.id}/edit" method="post">
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="platformsEditSubmitForm()" style="width:100%;height:32px">更新</button>
  </form>
  </div>
</div>
<script>
function platformsEditSubmitForm(){
  $('#platforms-edit-form').form({
    success: function(data) {
    	CMS.editSubmitHandler(data, platformsEL);
    }
  });
}
</script>
