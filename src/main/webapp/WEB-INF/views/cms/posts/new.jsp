...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="posts-add-form" action="/cms/posts/new" method="post">
    <div class="cms-mb20">
    ...
    <div class="cms-mb20">
      ...
      <input class="easyui-textbox" name="tags"  value="${web.keywords}" data-options="required:true, prompt:'标签'" style="width:100%;height:32px">
    </div>
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="postsAddSubmitForm()" style="width:100%;height:32px">确认</button>
  </form>
  </div>
</div>
<script>
function postsAddSubmitForm(){
  $('#posts-add-form').form({
    success: function(data) {
    	CMS.addSubmitHandler(data, postsEL);
    }
  });
}
</script>
