...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="shares-edit-form" action="/cms/shares/${record.id}/edit" method="post">
    <div class="cms-mb20">
    ...
    <div class="cms-mb20">
      ...
      <input class="easyui-textbox" name="keywords"  value="${record.keywords}" data-options="required:true, prompt:'标签'" style="width:100%;height:32px">
    </div>
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="sharesEditSubmitForm()" style="width:100%;height:32px">更新</button>
  </form>
  </div>
</div>
<script>
function sharesEditSubmitForm(){
  $('#shares-edit-form').form({
    success: function(data) {
    	CMS.editSubmitHandler(data, sharesEL);
    }
  });
}
</script>
